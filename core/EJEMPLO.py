                    ...
                    if choice == 1:
                        ...
                        while True:
                            ...
                            if choice == 1:
                                limpiar_pantalla()
                                while True:
                                    privada = True if param('Publica o privada?: ', str,
                                    ...
                                    if privada:
                                        ...
                                        invitado = None
                                    print(
                                        '1. PARTIDA CUSTOM')  # /game [POST] -> Crear Partida con id random, el mapa y añade al primer usuario
                                ...
                                while True:
                                    ...
                                    print(
                                        '2. CONTINUAR')  # /users/my_games [GET] #/game/<id>/game_state [GET] -> /game/<id>/ver_zona
                                    print('3. VOLVER')
                                    choice = param('Eliga una opción: ', int, valores_validos=[1, 2, 3])
                                    if choice == 1:
                                                ...
                                                if estado_partida == 'Empezada':
                                                    ...
                                                    if estado_jugador:
                                                        ...
                                                        if choice == 1:
                                                            coordenada = to_tuple()
                                                            while True:
                                                                zona, estado = ver_zona(token, id_user_partida,
                                                                                        coordenada)
                                                                if estado == 200:
                                                                    if zona[1]:
                                                                        print(zona[0])
                                                                        ...
                                                                        match choice:
                                                                            case 1:
                                                                                mostrar_texto(catalogos_dict['tropas'][
                                                                                                  'catalogo'])
                                                                                tropa = param(
                                                                                    'Introduzca el nombre de la tropa: ',
                                                                                    str, valores_validos=
                                                                                    catalogos_dict['tropas'][
                                                                                        'valores_validos'])
                                                                                cantidad = param(
                                                                                    'Introduzca la cantidad: ', int)
                                                                                mostrar_texto(
                                                                                    add_tropa(token, id_user_partida,
                                                                                              tropa, cantidad))
                                                                                limpiar_pantalla()
                                                                            ...
                                                                            case 4:
                                                                                ...
                                                                                edificio = param(
                                                                                    ...
                                                                                    catalogos_dict['edificios'][
                                                                                        'valores_validos'])
                                                                                mostrar_texto(construir_edificio(token,
                                                                                                                 id_user_partida,
                                                                                                                 edificio))
                                                                            case 5:
                                                                                edificio = param(
